# Comparing `tmp/balsamic-0.0.11.tar.gz` & `tmp/balsamic-0.0.12.tar.gz`
...
## Comparing `balsamic-0.0.11.tar` & `balsamic-0.0.12.tar`
...
### Comparing `balsamic-0.0.11/PKG-INFO` & `balsamic-0.0.12/PKG-INFO`
...
### Comparing `balsamic-0.0.11/README.md` & `balsamic-0.0.12/README.md`

 * *Files identical despite different names*

### Comparing `balsamic-0.0.11/balsamic.egg-info/PKG-INFO` & `balsamic-0.0.12/balsamic.egg-info/PKG-INFO`
...
### Comparing `balsamic-0.0.11/setup.py` & `balsamic-0.0.12/setup.py`
