# Comparing `tmp/musicntwrk-2.3.5.tar.gz` & `tmp/musicntwrk-2.3.6.tar.gz`
...
### Comparing `musicntwrk-2.3.5/README.md` & `musicntwrk-2.3.6/README.md`
...
### Comparing `musicntwrk-2.3.5/src/ml_utils/trainCNNmodel.py` & `musicntwrk-2.3.6/src/ml_utils/trainCNNmodel.py`
...
### Comparing `musicntwrk-2.3.5/src/networks/scoreDictionary.py` & `musicntwrk-2.3.6/src/networks/scoreDictionary.py`
...
### Comparing `musicntwrk-2.3.5/src/plotting/chordspace.py` & `musicntwrk-2.3.6/src/plotting/chordspace.py`
...
### Comparing `musicntwrk-2.3.5/src/timbre/computeCompMPS.py` & `musicntwrk-2.3.6/src/timbre/computeCompMPS.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/computeMFCC.py` & `musicntwrk-2.3.6/src/timbre/computeMFCC.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/computeModifiedASCBW.py` & `musicntwrk-2.3.6/src/timbre/computeModifiedASCBW.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/computePSCC.py` & `musicntwrk-2.3.6/src/timbre/computePSCC.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/computeStandardizedMFCC.py` & `musicntwrk-2.3.6/src/timbre/computeStandardizedMFCC.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/computeStandardizedMFPS.py` & `musicntwrk-2.3.6/src/timbre/computeStandardizedMFPS.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/computeStandardizedPSCC.py` & `musicntwrk-2.3.6/src/timbre/computeStandardizedPSCC.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/mfccSoundDecay.py` & `musicntwrk-2.3.6/src/timbre/mfccSoundDecay.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/mfccSoundDecayOptimal.py` & `musicntwrk-2.3.6/src/timbre/mfccSoundDecayOptimal.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/mfccSoundDecayPiecewise.py` & `musicntwrk-2.3.6/src/timbre/mfccSoundDecayPiecewise.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/minimizeBKPT.py` & `musicntwrk-2.3.6/src/timbre/minimizeBKPT.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/normSoundDecay.py` & `musicntwrk-2.3.6/src/timbre/normSoundDecay.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/timbre/normSoundDecay2.py` & `musicntwrk-2.3.6/src/timbre/normSoundDecay2.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/Remove.py` & `musicntwrk-2.3.6/src/utils/Remove.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/SegmentedLinearReg.py` & `musicntwrk-2.3.6/src/utils/SegmentedLinearReg.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/Sublists.py` & `musicntwrk-2.3.6/src/utils/Sublists.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/communications.py` & `musicntwrk-2.3.6/src/utils/communications.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/diffusionEntropyAnalyis.py` & `musicntwrk-2.3.6/src/utils/diffusionEntropyAnalyis.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/diffusionEntropyAnalyisNew.py` & `musicntwrk-2.3.6/src/utils/diffusionEntropyAnalyisNew.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/entropyKLdiv.py` & `musicntwrk-2.3.6/src/utils/entropyKLdiv.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/extractByString.py` & `musicntwrk-2.3.6/src/utils/extractByString.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/fetchWaves.py` & `musicntwrk-2.3.6/src/utils/fetchWaves.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/findLengthMax.py` & `musicntwrk-2.3.6/src/utils/findLengthMax.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/flatten.py` & `musicntwrk-2.3.6/src/utils/flatten.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/floatize.py` & `musicntwrk-2.3.6/src/utils/floatize.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/generalizedOpsHistogram.py` & `musicntwrk-2.3.6/src/utils/generalizedOpsHistogram.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/generalizedOpsName.py` & `musicntwrk-2.3.6/src/utils/generalizedOpsName.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/init_list_of_objects.py` & `musicntwrk-2.3.6/src/utils/init_list_of_objects.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/load_balancing.py` & `musicntwrk-2.3.6/src/utils/load_balancing.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/minimalDistance.py` & `musicntwrk-2.3.6/src/utils/minimalDistance.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/minimalDistanceVec.py` & `musicntwrk-2.3.6/src/utils/minimalDistanceVec.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/minimalNoBijDistance.py` & `musicntwrk-2.3.6/src/utils/minimalNoBijDistance.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/opsCheckByName.py` & `musicntwrk-2.3.6/src/utils/opsCheckByName.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/opsCheckByNameVec.py` & `musicntwrk-2.3.6/src/utils/opsCheckByNameVec.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/opsDistance.py` & `musicntwrk-2.3.6/src/utils/opsDistance.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/opsHistogram.py` & `musicntwrk-2.3.6/src/utils/opsHistogram.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/opsName.py` & `musicntwrk-2.3.6/src/utils/opsName.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/opsNameFull.py` & `musicntwrk-2.3.6/src/utils/opsNameFull.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/opsNameVec.py` & `musicntwrk-2.3.6/src/utils/opsNameVec.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/play_with_simpleaudio.py` & `musicntwrk-2.3.6/src/utils/play_with_simpleaudio.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/powerFit.py` & `musicntwrk-2.3.6/src/utils/powerFit.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/rhythmDistance.py` & `musicntwrk-2.3.6/src/utils/rhythmDistance.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/scaleFreeFit.py` & `musicntwrk-2.3.6/src/utils/scaleFreeFit.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/score2vLead.py` & `musicntwrk-2.3.6/src/utils/score2vLead.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/str2float.py` & `musicntwrk-2.3.6/src/utils/str2float.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/str2frac.py` & `musicntwrk-2.3.6/src/utils/str2frac.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.5/src/utils/vectorDistance.py` & `musicntwrk-2.3.6/src/utils/vectorDistance.py`
