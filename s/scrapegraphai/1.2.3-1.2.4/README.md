# Comparing `tmp/scrapegraphai-1.2.3.tar.gz` & `tmp/scrapegraphai-1.2.4.tar.gz`
...
### Comparing `scrapegraphai-1.2.3/.releaserc.yml` & `scrapegraphai-1.2.4/.releaserc.yml`
...
### Comparing `scrapegraphai-1.2.3/.github/ISSUE_TEMPLATE/bug_report.md` & `scrapegraphai-1.2.4/.github/ISSUE_TEMPLATE/bug_report.md`
...
### Comparing `scrapegraphai-1.2.3/docs/assets/apikey_1.png` & `scrapegraphai-1.2.4/docs/assets/apikey_1.png`
...
### Comparing `scrapegraphai-1.2.3/examples/anthropic/smart_scraper_haiku.py` & `scrapegraphai-1.2.4/examples/anthropic/smart_scraper_haiku.py`
...
### Comparing `scrapegraphai-1.2.3/examples/deepseek/smart_scarper_deepseek.py` & `scrapegraphai-1.2.4/examples/deepseek/smart_scarper_deepseek.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/deepseek/xml_scraper_deepseek.py` & `scrapegraphai-1.2.4/examples/deepseek/xml_scraper_deepseek.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/deepseek/inputs/books.xml` & `scrapegraphai-1.2.4/examples/deepseek/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/deepseek/inputs/example.json` & `scrapegraphai-1.2.4/examples/deepseek/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/csv_scraper_gemini.py` & `scrapegraphai-1.2.4/examples/gemini/csv_scraper_gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/custom_graph_gemini.py` & `scrapegraphai-1.2.4/examples/gemini/custom_graph_gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/json_scraper_gemini.py` & `scrapegraphai-1.2.4/examples/gemini/json_scraper_gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/scrape_plain_text_gemini.py` & `scrapegraphai-1.2.4/examples/gemini/scrape_plain_text_gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/scrape_xml_gemini.py` & `scrapegraphai-1.2.4/examples/gemini/scrape_xml_gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/script_generator_gemini.py` & `scrapegraphai-1.2.4/examples/gemini/script_generator_gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/search_graph_gemini.py` & `scrapegraphai-1.2.4/examples/gemini/search_graph_gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/smart_scraper_gemini.py` & `scrapegraphai-1.2.4/examples/gemini/smart_scraper_gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/xml_scraper_openai.py` & `scrapegraphai-1.2.4/examples/gemini/xml_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/inputs/books.xml` & `scrapegraphai-1.2.4/examples/gemini/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/inputs/example.json` & `scrapegraphai-1.2.4/examples/gemini/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/gemini/inputs/plain_html_example.txt` & `scrapegraphai-1.2.4/examples/gemini/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/groq/search_graph_groq_openai.py` & `scrapegraphai-1.2.4/examples/groq/search_graph_groq_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/groq/smart_scraper_groq_ollama.py` & `scrapegraphai-1.2.4/examples/groq/smart_scraper_groq_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/groq/smart_scraper_groq_openai.py` & `scrapegraphai-1.2.4/examples/groq/smart_scraper_groq_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/huggingfacehub/smart_scraper_huggingfacehub.py` & `scrapegraphai-1.2.4/examples/huggingfacehub/smart_scraper_huggingfacehub.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/csv_scraper_ollama.py` & `scrapegraphai-1.2.4/examples/local_models/csv_scraper_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/json_scraper_ollama.py` & `scrapegraphai-1.2.4/examples/local_models/json_scraper_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/scrape_plain_text_ollama.py` & `scrapegraphai-1.2.4/examples/local_models/scrape_plain_text_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/scrape_xml_ollama.py` & `scrapegraphai-1.2.4/examples/local_models/scrape_xml_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/script_generator_ollama.py` & `scrapegraphai-1.2.4/examples/local_models/script_generator_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/search_graph_ollama.py` & `scrapegraphai-1.2.4/examples/local_models/search_graph_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/smart_scraper_ollama.py` & `scrapegraphai-1.2.4/examples/local_models/smart_scraper_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/xml_scraper_ollama.py` & `scrapegraphai-1.2.4/examples/local_models/xml_scraper_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/inputs/books.xml` & `scrapegraphai-1.2.4/examples/local_models/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/inputs/example.json` & `scrapegraphai-1.2.4/examples/local_models/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/local_models/inputs/plain_html_example.txt` & `scrapegraphai-1.2.4/examples/local_models/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/mixed_models/search_graph_groq_ollama.py` & `scrapegraphai-1.2.4/examples/mixed_models/search_graph_groq_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/mixed_models/smart_scraper_mixed.py` & `scrapegraphai-1.2.4/examples/mixed_models/smart_scraper_mixed.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/mixed_models/inputs/books.xml` & `scrapegraphai-1.2.4/examples/mixed_models/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/mixed_models/inputs/example.json` & `scrapegraphai-1.2.4/examples/mixed_models/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/mixed_models/inputs/plain_html_example.txt` & `scrapegraphai-1.2.4/examples/mixed_models/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/csv_scraper_openai.py` & `scrapegraphai-1.2.4/examples/openai/csv_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/custom_graph_openai.py` & `scrapegraphai-1.2.4/examples/openai/custom_graph_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/deep_scraper_openai.py` & `scrapegraphai-1.2.4/examples/openai/deep_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/json_scraper_openai.py` & `scrapegraphai-1.2.4/examples/openai/json_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/omni_scraper_openai.py` & `scrapegraphai-1.2.4/examples/openai/omni_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/omni_search_graph_openai.py` & `scrapegraphai-1.2.4/examples/openai/omni_search_graph_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/scrape_plain_text_openai.py` & `scrapegraphai-1.2.4/examples/openai/scrape_plain_text_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/script_generator_openai.py` & `scrapegraphai-1.2.4/examples/openai/script_generator_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/search_graph_openai.py` & `scrapegraphai-1.2.4/examples/openai/search_graph_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/smart_scraper_openai.py` & `scrapegraphai-1.2.4/examples/openai/smart_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/speech_graph_openai.py` & `scrapegraphai-1.2.4/examples/openai/speech_graph_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/xml_scraper_openai.py` & `scrapegraphai-1.2.4/examples/openai/xml_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/inputs/books.xml` & `scrapegraphai-1.2.4/examples/openai/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/inputs/example.json` & `scrapegraphai-1.2.4/examples/openai/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/openai/inputs/plain_html_example.txt` & `scrapegraphai-1.2.4/examples/openai/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/single_node/fetch_node.py` & `scrapegraphai-1.2.4/examples/single_node/fetch_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/single_node/image2text_node.py` & `scrapegraphai-1.2.4/examples/single_node/image2text_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/examples/single_node/robot_node.py` & `scrapegraphai-1.2.4/examples/single_node/robot_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/manual deployment/commit_and_push.sh` & `scrapegraphai-1.2.4/manual deployment/commit_and_push.sh`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/manual deployment/commit_and_push_with_tests.sh` & `scrapegraphai-1.2.4/manual deployment/commit_and_push_with_tests.sh`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/builders/graph_builder.py` & `scrapegraphai-1.2.4/scrapegraphai/builders/graph_builder.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/docloaders/chromium.py` & `scrapegraphai-1.2.4/scrapegraphai/docloaders/chromium.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/__init__.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/__init__.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/abstract_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/abstract_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/base_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/base_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/csv_scraper_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/csv_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/deep_scraper_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/deep_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/json_scraper_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/json_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/omni_scraper_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/omni_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/omni_search_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/omni_search_graph.py`
...
### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/pdf_scraper_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/pdf_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/script_creator_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/script_creator_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/search_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/search_graph.py`
...
### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/smart_scraper_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/smart_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/speech_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/speech_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/graphs/xml_scraper_graph.py` & `scrapegraphai-1.2.4/scrapegraphai/graphs/xml_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/helpers/models_tokens.py` & `scrapegraphai-1.2.4/scrapegraphai/helpers/models_tokens.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/helpers/nodes_metadata.py` & `scrapegraphai-1.2.4/scrapegraphai/helpers/nodes_metadata.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/helpers/schemas.py` & `scrapegraphai-1.2.4/scrapegraphai/helpers/schemas.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/models/bedrock.py` & `scrapegraphai-1.2.4/scrapegraphai/models/bedrock.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/models/gemini.py` & `scrapegraphai-1.2.4/scrapegraphai/models/gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/models/openai_itt.py` & `scrapegraphai-1.2.4/scrapegraphai/models/openai_itt.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/models/openai_tts.py` & `scrapegraphai-1.2.4/scrapegraphai/models/openai_tts.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/__init__.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/__init__.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/base_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/base_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/conditional_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/conditional_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/fetch_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/fetch_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/generate_answer_csv_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/generate_answer_csv_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/generate_answer_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/generate_answer_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/generate_answer_omni_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/generate_answer_omni_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/generate_answer_pdf_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/generate_answer_pdf_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/generate_scraper_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/generate_scraper_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/get_probable_tags_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/get_probable_tags_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/graph_iterator_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/graph_iterator_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/image_to_text_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/image_to_text_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/merge_answers_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/merge_answers_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/parse_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/parse_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/rag_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/rag_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/robots_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/robots_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/search_internet_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/search_internet_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/search_link_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/search_link_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/nodes/text_to_speech_node.py` & `scrapegraphai-1.2.4/scrapegraphai/nodes/text_to_speech_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/cleanup_html.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/cleanup_html.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/convert_to_csv.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/convert_to_csv.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/convert_to_json.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/convert_to_json.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/parse_state_keys.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/parse_state_keys.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/prettify_exec_info.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/prettify_exec_info.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/proxy_rotation.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/proxy_rotation.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/research_web.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/research_web.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/save_audio_from_bytes.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/save_audio_from_bytes.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/sys_dynamic_import.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/sys_dynamic_import.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/scrapegraphai/utils/token_calculator.py` & `scrapegraphai-1.2.4/scrapegraphai/utils/token_calculator.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/graphs/scrape_json_ollama.py` & `scrapegraphai-1.2.4/tests/graphs/scrape_json_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/graphs/scrape_plain_text_llama3_test.py` & `scrapegraphai-1.2.4/tests/graphs/scrape_plain_text_llama3_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/graphs/scrape_plain_text_mistral_test.py` & `scrapegraphai-1.2.4/tests/graphs/scrape_plain_text_mistral_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/graphs/scrape_xml_ollama_test.py` & `scrapegraphai-1.2.4/tests/graphs/scrape_xml_ollama_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/graphs/script_generator_test.py` & `scrapegraphai-1.2.4/tests/graphs/script_generator_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/graphs/smart_scraper_ollama_test.py` & `scrapegraphai-1.2.4/tests/graphs/smart_scraper_ollama_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/graphs/inputs/books.xml` & `scrapegraphai-1.2.4/tests/graphs/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/graphs/inputs/example.json` & `scrapegraphai-1.2.4/tests/graphs/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/graphs/inputs/plain_html_example.txt` & `scrapegraphai-1.2.4/tests/graphs/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/nodes/fetch_node_test.py` & `scrapegraphai-1.2.4/tests/nodes/fetch_node_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/nodes/robot_node_test.py` & `scrapegraphai-1.2.4/tests/nodes/robot_node_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/utils/test_proxy_rotation.py` & `scrapegraphai-1.2.4/tests/utils/test_proxy_rotation.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/tests/utils/test_sys_dynamic_import.py` & `scrapegraphai-1.2.4/tests/utils/test_sys_dynamic_import.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/LICENSE` & `scrapegraphai-1.2.4/LICENSE`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.2.3/README.md` & `scrapegraphai-1.2.4/README.md`
...
### Comparing `scrapegraphai-1.2.3/pyproject.toml` & `scrapegraphai-1.2.4/pyproject.toml`
...
### Comparing `scrapegraphai-1.2.3/PKG-INFO` & `scrapegraphai-1.2.4/PKG-INFO`
