# Comparing `tmp/splight_lib-5.6.5.dev0.tar.gz` & `tmp/splight_lib-5.6.6.tar.gz`
...
### Comparing `splight_lib-5.6.5.dev0/splight_lib/models/base.py` & `splight_lib-5.6.6/splight_lib/models/base.py`
