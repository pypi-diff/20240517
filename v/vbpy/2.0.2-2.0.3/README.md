# Comparing `tmp/vbpy-2.0.2.tar.gz` & `tmp/vbpy-2.0.3.tar.gz`
...
## Comparing `vbpy-2.0.2.tar` & `vbpy-2.0.3.tar`
...
### Comparing `vbpy-2.0.2/setup.py` & `vbpy-2.0.3/setup.py`
...
### Comparing `vbpy-2.0.2/vbpy/combine_data_file.py` & `vbpy-2.0.3/vbpy/combine_data_file.py`

 * *Files identical despite different names*

### Comparing `vbpy-2.0.2/vbpy/load_claim_auto_file.py` & `vbpy-2.0.3/vbpy/load_claim_auto_file.py`
...
### Comparing `vbpy-2.0.2/vbpy/load_revenue_auto_file.py` & `vbpy-2.0.3/vbpy/load_revenue_auto_file.py`
